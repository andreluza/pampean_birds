...
#                     The output of the 2nd model


#         hat(psi[i]) (dry grassland, regenerating grassland)
...
av_rel <-data.frame (x=seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100), # stand value
                     ...
                     pred= plogis(res_mod_grass[[1]]$mean$int.psi+
                                    res_mod_grass[[1]]$mean$beta.grass*seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100))
)
...
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[1]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[1]]$sims.list$beta.grass),
  sample=rownames(melt(res_mod_grass[[1]]$sims.list$beta.grass)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames


# predict for each MCMC sample
pred_data <- lapply (seq (1,length(res_mod_grass[[1]]$sims.list$int.psi)), function (i)
...
av_rel <-data.frame (x=seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100), # stand value
                     ...
                     pred= plogis(res_mod_grass[[1]]$mean$int.psi+
                                    res_mod_grass[[1]]$mean$beta.res*seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100))
)
...
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[1]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[1]]$sims.list$beta.res),
  sample=rownames(melt(res_mod_grass[[1]]$sims.list$beta.res)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames
...
av_rel <-data.frame (x=seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100), # stand value
                     x_nat = seq(min(grassland_dry), max(grassland_dry),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[2]]$mean$int.psi+
                                    res_mod_grass[[2]]$mean$beta.grass*seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100))
)
...
# extract coeffs
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[2]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[2]]$sims.list$beta.grass),
  sample=rownames(melt(res_mod_grass[[2]]$sims.list$beta.grass)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames


# predict for each MCMC sample
pred_data <- lapply (seq (1,length(res_mod_grass[[2]]$sims.list$int.psi)), function (i)
...
av_rel <-data.frame (x=seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100), # stand value
                     x_nat = seq(min(grassland_reg), max(grassland_reg),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[2]]$mean$int.psi+
                                    res_mod_grass[[2]]$mean$beta.res*seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100))
)
...
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[2]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[2]]$sims.list$beta.res),
  sample=rownames(melt(res_mod_grass[[2]]$sims.list$beta.res)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames
...
av_rel <-data.frame (x=seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100), # stand value
                     x_nat = seq(min(grassland_dry), max(grassland_dry),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[3]]$mean$int.psi+
                                    res_mod_grass[[3]]$mean$beta.grass*seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100))
)
...
# extract coeffs
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[3]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[3]]$sims.list$beta.grass),
  sample=rownames(melt(res_mod_grass[[3]]$sims.list$beta.grass)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames


# predict for each MCMC sample
pred_data <- lapply (seq (1,length(res_mod_grass[[3]]$sims.list$int.psi)), function (i)
...
av_rel <-data.frame (x=seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100), # stand value
                     x_nat = seq(min(grassland_reg), max(grassland_reg),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[3]]$mean$int.psi+
                                    res_mod_grass[[3]]$mean$beta.res*seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100))
)
...
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[3]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[3]]$sims.list$beta.res),
  sample=rownames(melt(res_mod_grass[[3]]$sims.list$beta.res)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames
...
av_rel <-data.frame (x=seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100), # stand value
                     x_nat = seq(min(grassland_dry), max(grassland_dry),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[4]]$mean$int.psi+
                                    res_mod_grass[[4]]$mean$beta.grass*seq(min(list_covs$grass_dry), max(list_covs$grass_dry),length.out=100))
)
...
# extract coeffs
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[4]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[4]]$sims.list$beta.grass),
  sample=rownames(melt(res_mod_grass[[4]]$sims.list$beta.grass)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames


# predict for each MCMC sample
pred_data <- lapply (seq (1,length(res_mod_grass[[4]]$sims.list$int.psi)), function (i)
...
av_rel <-data.frame (x=seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100), # stand value
                     x_nat = seq(min(grassland_reg), max(grassland_reg),length.out=100), # real covariate value
                     pred= plogis(res_mod_grass[[4]]$mean$int.psi+
                                    res_mod_grass[[4]]$mean$beta.res*seq(min(list_covs$grass_res), max(list_covs$grass_res),length.out=100))
)
...
coeff_to_pred <- data.frame (
  int=melt (res_mod_grass[[4]]$sims.list$int.psi),
  grass=melt(res_mod_grass[[4]]$sims.list$beta.res),
  sample=rownames(melt(res_mod_grass[[4]]$sims.list$beta.res)))
colnames(coeff_to_pred) <- c("int","grass","sample") # set colnames
...
df_fss<-lapply (seq(1,length(list_sp)), function (i)
  ...
  data.frame (species = list_sp[i],
              p=res_mod_grass[[i]]$sims.list$mean.p,
              psi=res_mod_grass[[i]]$sims.list$mean.psi
              #fss=res_mod_grass[[i]]$sims.list$fss
  ))
...
pred_data <- lapply (seq (1,length(list_sp)), function (i) {
    ...
    av_rel <-data.frame (x=seq(min(list_covs$det_area), max(list_covs$det_area),length.out=100), # stand value
                         ...
                         pred= plogis(res_mod_grass[[i]]$mean$int.p+
                                        res_mod_grass[[i]]$mean$alpha.area*seq(min(list_covs$det_area), max(list_covs$det_area),length.out=100)),
                         sp=list_sp[i]
    ...
    # extract coeffs
    coeff_to_pred <- data.frame (
      int=melt (res_mod_grass[[i]]$sims.list$int.p),
      area=melt(res_mod_grass[[i]]$sims.list$alpha.area),
      sample=rownames(melt(res_mod_grass[[i]]$sims.list$alpha.area)))
    colnames(coeff_to_pred) <- c("int","area","sample") # set colnames
    
    
    # predict for each MCMC sample
    pred_data <- lapply (seq (1,length(res_mod_grass[[i]]$sims.list$alpha.area)), function (k)
...
pred_data_temp <- lapply (seq (1,length(list_sp)), function (i) {
  ...
  av_rel <-data.frame (x=seq(min(list_covs$temp,na.rm=T), max(list_covs$temp,na.rm=T),length.out=100), # stand value
                       ...
                       pred= plogis(res_mod_grass[[i]]$mean$int.p+
                                      res_mod_grass[[i]]$mean$alpha.temp*seq(min(list_covs$temp,na.rm=T), 
  ...
  coeff_to_pred <- data.frame (
    int=melt (res_mod_grass[[i]]$sims.list$int.p),
    temp=melt(res_mod_grass[[i]]$sims.list$alpha.temp),
    sample=rownames(melt(res_mod_grass[[i]]$sims.list$alpha.temp)))
  colnames(coeff_to_pred) <- c("int","temp","sample") # set colnames
  
  
  # predict for each MCMC sample
  pred_data <- lapply (seq (1,length(res_mod_grass[[i]]$sims.list$alpha.temp)), function (k)
...
pred_data_umid <- lapply (seq (1,length(list_sp)), function (i) {
  ...
  av_rel <-data.frame (x=seq(min(list_covs$umid,na.rm=T), max(list_covs$umid,na.rm=T),length.out=100), # stand value
                       ...
                       pred= plogis(res_mod_grass[[i]]$mean$int.p+
                                      res_mod_grass[[i]]$mean$alpha.umid*seq(min(list_covs$umid,na.rm=T), 
  ...
  coeff_to_pred <- data.frame (
    int=melt (res_mod_grass[[i]]$sims.list$int.p),
    umid=melt(res_mod_grass[[i]]$sims.list$alpha.umid),
    sample=rownames(melt(res_mod_grass[[i]]$sims.list$alpha.umid)))
  colnames(coeff_to_pred) <- c("int","umid","sample") # set colnames
  
  
  # predict for each MCMC sample
  pred_data <- lapply (seq (1,length(res_mod_grass[[i]]$sims.list$alpha.umid)), function (k)
...
pred_data_turno <- lapply (seq (1,length(list_sp)), function (i) {
  ...
  av_rel <-data.frame (x=c(0,1), # stand value
                       ...
                       pred= c(plogis(res_mod_grass[[i]]$mean$int.p),
                               plogis(res_mod_grass[[i]]$mean$int.p+
                                      res_mod_grass[[i]]$mean$alpha.turno * 1)
                               ),
                       sp=list_sp[i]
  ...
  coeff_to_pred <- data.frame (
    int=melt (res_mod_grass[[i]]$sims.list$int.p),
    turno=melt(res_mod_grass[[i]]$sims.list$alpha.turno),
    sample=rownames(melt(res_mod_grass[[i]]$sims.list$alpha.turno)))
  colnames(coeff_to_pred) <- c("int","turno","sample") # set colnames
  
  
  # predict for each MCMC sample
  pred_data <- lapply (seq (1,length(res_mod_grass[[i]]$sims.list$alpha.turno)), function (k)
